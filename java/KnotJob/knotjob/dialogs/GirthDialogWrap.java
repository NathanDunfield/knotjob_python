...
import knotjob.links.GirthMinimizer;

/**
 *
 * @author Dirk
 */
public class GirthDialogWrap extends DialogWrap{
    ...
    public GirthDialogWrap(JFrame fram) {
        super(null, null);
        frame = new JDialog(new JFrame(), "Minimize Girth", true);
        frm = fram;
    ...
    public void setup(GirthMinimizer giMi) {
